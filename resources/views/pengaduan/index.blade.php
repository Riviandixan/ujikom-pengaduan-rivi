                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="isi_laporan" id="isi_laporan" rows="9" class="form-control"
            ...
            <table class="table table-bordered zero-configuration">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('pengaduan.destroy', $pengaduan->id) }}" onsubmit="return confirm('Apakah Anda Yakin?');" method="POST">
                                <a href="{{ route('pengaduan.show', $pengaduan->id) }}" class="btn btn-warning btn-sm" title="show">

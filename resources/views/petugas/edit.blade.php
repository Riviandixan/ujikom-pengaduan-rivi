                ...
                <form action="{{ route('petugas.update', $petugas->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" class="form-control" value="{{ $petugas->phone }}">
                        </div>
                        <div class="form-group">
                            <strong>Role</strong>
                    ...
                    <br>
                    <button type="submit" id="btn-submit" class="btn font-weight-bold btn-block btn-primary">
                        Update
                    </button>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin?');"
                                    action="{{ route('petugas.destroy', $data->id) }}" method="POST">
                                    ...
                                    <a href="{{ route('petugas.show', $data->id) }}" class="btn btn-warning btn-sm"
                                        title="show">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"

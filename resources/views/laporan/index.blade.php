        ...
        <div class="row">
            <div class="col-md-12 mt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 align-items-end">
                        {{-- Cetak pdf --}}
                        <a type="button" class="dt-button export-excel btn btn-danger form-control export-pdf" href="{{ route('cetak_pdf', ['start_date' => $start_date, 'end_date' => $end_date]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
